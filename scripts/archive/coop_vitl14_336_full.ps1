...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\CoOp\vit_l14_336_iwildcam_ctx.yaml"
$OutputRoot = Join-Path $RepoRoot "outputs\coop_iwildcam_vitl14_336_full_seed1"
