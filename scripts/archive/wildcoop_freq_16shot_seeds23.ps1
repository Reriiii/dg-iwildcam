...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\WildCoOpA\vit_b16_iwildcam_freq_16shot.yaml"
...
foreach ($seed in $seeds) {
    $OutputRoot = Join-Path $RepoRoot "outputs\wildcoop_a_iwildcam_vitb16_16shot_freq_only_seed$seed"
    ...
    "=== WildCoOp-A freq_only ViT-B/16 16-shot seed $seed ==="
