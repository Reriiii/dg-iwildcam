...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\CoOpLoRA\vitl14_336_iwildcam_full_10ep.yaml"
$OutputRoot = Join-Path $RepoRoot "outputs\coop_lora_iwildcam_vitl14_336_full_seed1_10ep"
