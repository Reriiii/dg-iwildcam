...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\WildCoOpA\vit_b16_iwildcam_freq_fullfreq_16shot.yaml"
...
foreach ($seed in $seeds) {
    $OutputRoot = Join-Path $RepoRoot "outputs\wildcoop_a_iwildcam_vitb16_16shot_freq_fullfreq_seed$seed"
    ...
    "=== WildCoOp-A freq_fullfreq ViT-B/16 16-shot seed $seed ==="
