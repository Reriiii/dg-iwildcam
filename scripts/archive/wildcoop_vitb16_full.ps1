...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\WildCoOpA\vit_b16_iwildcam_full.yaml"
$OutputRoot = Join-Path $RepoRoot "outputs\wildcoop_a_iwildcam_vitb16_full_seed1"
