...
$TrainerConfig = Join-Path $CoOpRoot "configs\trainers\WildCoOpA\vitl14_336_iwildcam_full.yaml"
$OutputRoot = Join-Path $RepoRoot "outputs\wildcoop_a_iwildcam_vitl14_336_full_seed1"
